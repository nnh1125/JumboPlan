    ...
    <nav className="flex items-center justify-between py-6">
      <div className="flex items-center gap-2">
        <svg width="50" height="50" viewBox="0 0 270 270" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M140 212H146M140 212V218H146V212M140 212V206H146M146 212H152M146 212V206M158 206V200H152V206M158 206H152M158 206V212H152M152 206V212M152 206H146" stroke="#5C4C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <path d="M52 144H58M52 144V150M52 144H46V150H52M52 144V138H58V144M58 144V150M58 144H64V150H58M58 150H52M58 150V156H52V150" stroke="#5C4C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
