...
export default async function HomePage() {
  ...
  if (!userId) {
    return (
      <main className="min-h-screen bg-white text-slate-900" style={{ background: "linear-gradient(180deg, #E3F1F9 0%, #BAE3FA 100%)" }}>
{/*       
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0 max-h-[10vh] bg-gradient-to-b from-white/40 via-transparent to-slate-50/60" />
      </div> */}
